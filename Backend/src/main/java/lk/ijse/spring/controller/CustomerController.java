...
public class CustomerController {
    ...
    public ResponseEntity<ResponseDTO> getAllCustomers() {
        if (customerService.getAllCustomers() != null) {
            return ResponseEntity.ok(new ResponseDTO(HttpServletResponse.SC_OK,"All Customers",customerService.getAllCustomers()));
            ...
            return ResponseEntity.ok(new ResponseDTO(HttpServletResponse.SC_OK,"Error",null));
    ...
    public ResponseEntity<ResponseDTO> searchCustomer(@PathVariable String id) {
        if (customerService.searchCustomer(id) != null) {
            ...
            return ResponseEntity.ok(new ResponseDTO(HttpServletResponse.SC_INTERNAL_SERVER_ERROR,"No Such Customer...",null));
        }
    }

    @PostMapping(consumes = MediaType.APPLICATION_FORM_URLENCODED_VALUE)
    public ResponseEntity<ResponseDTO> saveCustomer(@ModelAttribute CustomerDTO dto) {
        ...
        if (customerService.saveCustomer(dto)) {
            return ResponseEntity.status(HttpStatus.CREATED).body(new ResponseDTO(HttpServletResponse.SC_CREATED,"Customer Saved Successfully..!",null));
        } else {
            return ResponseEntity.ok(new ResponseDTO(HttpServletResponse.SC_BAD_REQUEST,"Something Went Wrong...",null));
        }
    }

    @PutMapping(consumes = MediaType.APPLICATION_JSON_VALUE)
    public ResponseEntity<ResponseDTO> updateCustomer(@RequestBody CustomerDTO dto) {
       /* if (customerService.updateCustomer(dto)) {
        ...
        if (customerService.updateCustomer(dto)) {
           // return ResponseEntity.status(HttpStatus.CREATED).body(new ResponseDTO(HttpServletResponse.SC_OK,"Customer Updated Successfully..!",null));
            return ResponseEntity.ok(new ResponseDTO(HttpServletResponse.SC_OK,"Customer Updated Successfully..!",null));
        } else {
            return ResponseEntity.ok(new ResponseDTO(HttpServletResponse.SC_BAD_REQUEST,"Something Went Wrong...",null));
        }
    }
    ...
    public ResponseEntity<ResponseDTO> deleteCustomer(@RequestParam String id) {
        ...
        if (customerService.deleteCustomer(id)) {
            return ResponseEntity.ok(new ResponseDTO(HttpServletResponse.SC_OK,"Customer Deleted Successfully..!",null));
        } else {
            return ResponseEntity.ok(new ResponseDTO(HttpServletResponse.SC_BAD_REQUEST,"Something Went Wrong...",null));
        }
    }
